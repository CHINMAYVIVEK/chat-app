...
func (c *chatServiceClient) SendMsg(ctx context.Context, in *ChatMessage, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/chat.ChatService/sendMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) ReceiveMsg(ctx context.Context, in *Empty, opts ...grpc.CallOption) (ChatService_ReceiveMsgClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], "/chat.ChatService/receiveMsg", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatServiceClient) GetAllUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
	err := c.cc.Invoke(ctx, "/chat.ChatService/getAllUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatService_SendMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/sendMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatService_GetAllUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/getAllUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
